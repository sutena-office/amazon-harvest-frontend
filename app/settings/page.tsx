  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      <header className="bg-gray-800 border-b border-gray-700 px-6 py-4 flex justify-between items-center">
        <h1 className="text-lg font-bold text-orange-400">設定</h1>
      ...
      <main className="max-w-xl mx-auto px-4 py-8">
        {loading ? <p className="text-gray-400">読み込み中...</p> : (
          <form onSubmit={handleSave} className="bg-gray-800 rounded-xl border border-gray-700 p-6 space-y-5">
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-200 mb-1">最低利益率（%）</label>
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-200 mb-1">最低利益額（円）</label>
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-200 mb-1">最低値下がり率（%）</label>
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-200 mb-1">最大ランキング（売れ筋フィルター）</label>
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-200 mb-1">Amazon手数料率（%）</label>
